...
You can find its git repository [here](https://git.embl.de/klaus/tidyverse_R_intro).
...
Type                Link 
------      ------------------
Slides      [Slides](http://www.tinyurl.com/BK-XT85/Teaching/Slides_tidyverse_R_intro.html) 

Lab         [Lab pdf](https://git.embl.de/klaus/tidyverse_R_intro/raw/master/R-lab.pdf)                     

R script    [R--script](https://git.embl.de/klaus/tidyverse_R_intro/raw/master/R-lab.R) 

Rmd         [.Rmd file](https://git.embl.de/klaus/tidyverse_R_intro/raw/master/R-lab.Rmd)    
--------------------------------------------------------------------------------                                
...
You can find its git repository [here](https://git.embl.de/klaus/graphics_and_data_handling).
...
Type                Link 
------      ------------------
Slides      [Slides](http://www.tinyurl.com/BK-XT85/Teaching/slides_graphics_and_data_handling.html) 

Lab         [Lab pdf](https://git.embl.de/klaus/graphics_and_data_handling/blob/master/graphics_and_data_handling.pdf)                     

R script    [R--script](https://git.embl.de/klaus/graphics_and_data_handling/blob/master/graphics_and_data_handling.R) 

Rmd         [.Rmd file](https://git.embl.de/klaus/graphics_and_data_handling/blob/master/graphics_and_data_handling.Rmd)    
--------------------------------------------------------------------------------                                
...
You can find its git repository  [here](https://git.embl.de/klaus/htm_course_2016).
